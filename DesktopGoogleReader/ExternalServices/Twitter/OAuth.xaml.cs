...
namespace DesktopGoogleReader.ExternalServices.Twitter
{
    /// <summary>
    ...
    public partial class OAuth : Window
    {
        ...
        public OAuth()
        {
            ...
            _consumerKey = Settings.Default.TwitterConsumerKey;
            _consumerSecret = Settings.Default.TwitterConsumerSecret;
        ...
        private void okBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            Settings.Default.TwitterAccessToken = result.Token;
            Settings.Default.TwitterAccessTokenSecret = result.TokenSecret;
