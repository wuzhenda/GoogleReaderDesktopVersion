...
namespace DesktopGoogleReader
{
    class LogWriter
    {
        static private string LogFilePathAndName = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Desktop Google Reader\\UserInterface.txt";
        static private bool isEnabled = false;

        public static void CreateLogfile()
        {
//            if (Properties.Settings.Default.writeLogfiles)
            if(isEnabled)
            {
