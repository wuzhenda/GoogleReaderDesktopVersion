    ...
    public class Reader : IReader
    {
        ...
        public IEnumerable<UnreadFeed> GetUnreadFeeds()
        {
            ...
            return from u in unreadFeeds
                   ...
                   {
                       Url = s.XPathSelectElement("string[@name='id']").Value.Replace("feed/", ""),
        ...
        private string CoreGetUnreadItems(int topN)
        {
        ...
        public IEnumerable<UnreadItem> GetUnreadItems() 
        {
            ...
            */
            ...
            int topN = Math.Min(20, GetUnreadCount());
            ...
            */
            return DeserializeItemsJson(CoreGetUnreadItems(topN), (e => true));
        ...
        public IEnumerable<UnreadItem> GetNewUnreadItems(Dictionary<string, string> oldUnreadItemIds)
        {
            ...
            return DeserializeItemsJson(CoreGetUnreadItems(topN), checkAction);
